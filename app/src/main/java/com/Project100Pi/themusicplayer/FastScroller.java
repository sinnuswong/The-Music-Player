...
public class FastScroller extends LinearLayout{
  ...
  private static int bubblePos,handlePos ;
...
//      recyclerView.oPositionWithOffset(targetPos);
  ...
  private void setBubbleAndHandlePosition(float y)
    ...
    int handleHeight=handle.getHeight();
      int handleSetY = getValueInRange(0, height - handleHeight, (int) (y - handleHeight / 2));
      int bubbleSetY = getValueInRange(0, height - bubbleHeight - handleHeight / 2, (int) (y - bubbleHeight));
    handle.setY(handleSetY);
    bubble.setY(bubbleSetY);
