        ...
        while (true) {
                ...
                if (firstSampleData
                    ...
                    if (mProgressListener != null) {
                        if (!mProgressListener.reportProgress((float)(tot_size_read) / mFileSize)) {
                            ...
                            Log.v("App","We are asked to stop reading the file");
                            extractor.release();
                            extractor = null;
                            codec.stop();
                            codec.release();
            ...
            if (outputBufferIndex >= 0 && info.size > 0) {
                ...
                if (mDecodedBytes.remaining() < info.size) {
                    ...
                    Log.d("THE MUSIC PLAYER","newsize is "+newSize);
                    ...
                    while(retry > 0) {
                        try {
                            ...
                            Log.e("THE MUSIC PLAYER","MemoryException even though I have requested for LargeHeap");
                            System.gc();
                            Log.d("THE MUSIC PLAYER","Garbage Collection notified");
                    ...
                    if (retry == 0) {
                        ...
                        Log.e("THE MUSIC PLAYER","Failed to allocate memory in all the 10 attempts");
                        break;
                    }
